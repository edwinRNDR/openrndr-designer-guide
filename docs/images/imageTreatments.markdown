...
# Edit 'src/main/kotlin/docs/50_Images/C200_Image_treatments.kt' instead.
layout: default
...
<img alt="../media/image-treatment-0010.png" src="../media/image-treatment-0010.png" loading="lazy"> 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/50_Images/C200_Image_treatments000.kt) 
 
## Treatment 2

Use a pattern shade style to create a rings effect, combine with a luma gradient to recolor the image. 
 
<img alt="../media/image-treatment-0020.png" src="../media/image-treatment-0020.png" loading="lazy"> 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/50_Images/C200_Image_treatments001.kt) 
 
## Treatment 3

Use a pattern shade style to create a line effect, combine with a luma gradient to recolor the image. 
 
<img alt="../media/image-treatment-0030.png" src="../media/image-treatment-0030.png" loading="lazy"> 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/50_Images/C200_Image_treatments002.kt) 
 
## Treatment 4

Use an image fill shade style to create a warped image effect. 
 
<img alt="../media/image-treatment-0040.png" src="../media/image-treatment-0040.png" loading="lazy"> 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/50_Images/C200_Image_treatments003.kt) 
 
## Treatment 5

Use an image fill shade style to create a warped mosaic image effect. 
 
<img alt="../media/image-treatment-0050.png" src="../media/image-treatment-0050.png" loading="lazy"> 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/50_Images/C200_Image_treatments004.kt) 
 
## Treatment 6

Use an image fill shade style to create a skewed pixelated image effect. 
 
<img alt="../media/image-treatment-0060.png" src="../media/image-treatment-0060.png" loading="lazy"> 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/50_Images/C200_Image_treatments005.kt) 
 
## Treatment 7

Use an image fill shade style to create a animated pixelated and dithered image effect. 
 
<img alt="../media/image-treatment-0070.png" src="../media/image-treatment-0070.png" loading="lazy"> 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/50_Images/C200_Image_treatments006.kt) 
 
## Treatment 8

Use an image fill shade style to create a noisy blur effect. 
 
<img alt="../media/image-treatment-0080.png" src="../media/image-treatment-0080.png" loading="lazy"> 
...
[Link to the full example](https://github.com/openrndr/openrndr-examples/blob/master/src/main/kotlin/examples/50_Images/C200_Image_treatments007.kt) 

[edit on GitHub](https://github.com/openrndr/openrndr-guide/blob/main/src/main/kotlin/docs/50_Images/C200_Image_treatments.kt){: .btn .btn-github }